...
# 从测试号信息获取
appID = "wx362f8f3a237038a0"
appSecret = "458010b5a7a0f0cf86bcbbfe8ebf1c96"
#收信人ID即 用户列表中的微信号，见上文
openId = "o1ef454V3_XGP0QZoP2s92aXn5o4"
# 天气预报模板ID
weather_template_id = "g5F8YskUAk2vd9vuzhSZaeD-BWJy62MwDKj7nJmftU0"
# 时间表模板ID
timetable_template_id = "eyw1FK3ru3r0zxWjMdcnop4j5Q-BrD71mnG9vStfMkg"


def get_weather(my_city):
    urls = ["http://www.weather.com.cn/textFC/hb.shtml&quot",
            "http://www.weather.com.cn/textFC/db.shtml",
            "http://www.weather.com.cn/textFC/hd.shtml&quot",
            "http://www.weather.com.cn/textFC/hz.shtml&quot",
...
if __name__ == '__main__':
    ...
    schedule.every().day.at("08:30").do(timetable, "不要忘记上班打卡小刘")
    schedule.every().day.at("18:00").do(timetable, "不要忘记下班打卡小刘")
    schedule.every().day.at("18:30").do(timetable, "不要忘记下班打卡小刘")
    schedule.every().friday.at("13:50").do(timetable, "不要忘记写周报小刘")
    while True:
